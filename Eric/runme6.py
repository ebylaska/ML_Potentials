...
nn_machine  = myfeedforward3.MyFeedForward([nparameters,nparameters,nparameters,nparameters,nparameters,nparameters,1],[sigmoid,sigmoid,sigmoid,sigmoid,sigmoid,sigmoid,lambda x: x],[sigmoidp,sigmoidp,sigmoidp,sigmoidp,sigmoidp,sigmoidp,lambda x: 1], [sigmoidpp,sigmoidpp,sigmoidpp,sigmoidpp,sigmoidpp,sigmoidpp,lambda x: 0])
nn_weights  = []

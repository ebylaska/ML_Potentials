...
nn_machine  = myfeedforward.MyFeedForward([nparameters,nparameters,nparameters,nparameters,nparameters,1],[lambda x: x,sigmoid,sigmoid,sigmoid,sigmoid,lambda x: x],[lambda x: 1,sigmoidp,sigmoidp,sigmoidp,sigmoidp,lambda x: 1], [lambda x: 0,sigmoidpp,sigmoidpp,sigmoidpp,sigmoidpp,lambda x: 0])
nn_weights  = []
...
print("\n\n")
datafp = open("frameerror4a.dat",'w')

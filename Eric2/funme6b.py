...
nn_machine  = myfeedforward.MyFeedForward([nparameters,nparameters,nparameters,1],[sigmoid,sigmoid,sigmoid,lambda x: x],[sigmoidpsigmoidp,sigmoidp,lambda x: 1], [sigmoidpp,sigmoidpp,lambda x: 0])
nn_weights  = []
